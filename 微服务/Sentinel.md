...
被隔离的这个资源直接就不可用了，就好比咱们查询购物车直接查不到了，这就很尴尬，我们怎么解决呢？
...
仅仅做线程隔离是不够的，还要进行服务熔断，因为既然知道商品服务已经挂了，还去访问他，每次都是很久才返回，就很尴尬，所以用到了服务熔断，进一步节省资源

![](assets/Sentinel/file-20251128093733176.png)

**断路器**熔断状态流转图：
![](assets/Sentinel/file-20251128093700618.png)
