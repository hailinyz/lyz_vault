...
![](assets/网关、配置管理（热更新）、动态路由/file-20251124233747666.jpeg)
但是拆分成微服务之后就麻烦了：所以有了**网关**

就比如找人，你得有户口簿、打野才会给你开门，如果你不知道你要找的人在哪，大爷会带你去，这就叫做网关。
![](assets/网关、配置管理（热更新）、动态路由/file-20251124233747666.png)
下面给你看更加专业的图
![](assets/网关、配置管理（热更新）、动态路由/file-20251124233747671.png)
...
![](assets/网关、配置管理（热更新）、动态路由/file-20251124233747673.png)
...
### 执行顺序
![](assets/网关、配置管理（热更新）、动态路由/file-20251124233747688.png)
...
### OpenFeign传递用户
![](assets/网关、配置管理（热更新）、动态路由/file-20251124233747717.png)
![](assets/网关、配置管理（热更新）、动态路由/file-20251124233747718.png)
...
2. 微服务拉去共享配置
具体流程图
![](assets/网关、配置管理（热更新）、动态路由/file-20251124233747720.png)
```xml
<!--nacos配置管理-->
<dependency>
...
![](assets/网关、配置管理（热更新）、动态路由/file-20251124233747720%201.png)
JSON：
```json
[
    {
