...
![](assets/Day4/file-20251207141810952.png)
这幅图是请求先经过网关的过滤器，然后转发到具体的服务上 ，拦截器是绑定在具体服务上的

有多个token的时候在退出登录的时候就可以删除token或者在请求url的时候通过拿到的用户信息清除之前的token